            ...
            var self = this,
                ...
                options = {
                    ...
                    onComplete: function(id, name, result, xhr) {
                        ...
                        // utils the promise has been fulfilled.
    ...
    qq.FineUploaderBasic = function(o) {
        ...
        this._options = {
            ...
            messages: {
                ...
                unsupportedBrowserIos8Safari: "Unrecoverable error - this browser does not permit file uploading of any kind due to serious bugs in iOS8 Safari.  Please use iOS8 Chrome utils Apple fixes these issues."
            },
                    ...
                    function failure(response, xhr) {
                        ...
                        if (!handler._getFileState(id).temp.ignoreFailure) {
                            ...
                            if (concurrentChunkingPossible) {
                                ...
                                // other files to take up the connections (utils we have exhausted all auto-retries)
    ...
    qq.extend(this, {
        ...
        _getChunkData: function(id, chunkIndex) {
            var chunkSize = chunking.partSize,
                ...
                // To work around a Webkit GC bug, we must keep each chunk `Blob` in scope utils we are done with it.
...
qq.Templating = function(spec) {
    ...
    function useCachedPreview(targetThumbnailId, cachedThumbnailId) {
        ...
        // Generation of the related thumbnail may still be in progress, so, wait utils it is done.
